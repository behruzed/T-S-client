import {
  ...
  Breadcrumb_default,
  useEventListener
} from "./chunk-RHQI7HSV.js";
import {
  Button_default as Button_default2
} from "./chunk-WNYGGHCD.js";
import {
  Button_default
...
function useUpdateEffect(fn2, deps) {
  var isFirst = (0, import_react10.useRef)(true);
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  ...
  return [isProp2 ? propValue : stateValue, (0, import_react13.useCallback)((value, ...args) => {
    if (handler)
      handler(value, ...args);
    setState(value);
  }, [handler])];
...
function useForceUpdate() {
  var _useReducer = (0, import_react14.useReducer)(function(state) {
    return !state;
...
function useSafeState(state) {
  var isMounted = useMounted();
  return [state[0], (0, import_react15.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
var $704cf1d3b684cc5c$var$SSRContext = (0, import_react19.default).createContext($704cf1d3b684cc5c$var$defaultContext);
function $704cf1d3b684cc5c$var$LegacySSRProvider(props) {
  let cur = (0, import_react19.useContext)($704cf1d3b684cc5c$var$SSRContext);
  ...
  return (0, import_react19.default).createElement($704cf1d3b684cc5c$var$SSRContext.Provider, {
    value
  }, props.children);
}
...
function $704cf1d3b684cc5c$export$9f8ac96af4b1b2ae(props) {
  ...
  return (0, import_react19.default).createElement($704cf1d3b684cc5c$var$LegacySSRProvider, props);
}
...
function $704cf1d3b684cc5c$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react19.useContext)($704cf1d3b684cc5c$var$SSRContext);
...
function $704cf1d3b684cc5c$var$useModernSSRSafeId(defaultId) {
  ...
  let [didSSR] = (0, import_react19.useState)($704cf1d3b684cc5c$export$535bd6ca7f90a273());
  let prefix = didSSR ? "react-aria" : `react-aria${$704cf1d3b684cc5c$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
var $704cf1d3b684cc5c$export$619500959fc48b26 = typeof (0, import_react19.default)["useId"] === "function" ? $704cf1d3b684cc5c$var$useModernSSRSafeId : $704cf1d3b684cc5c$var$useLegacySSRSafeId;
...
function $704cf1d3b684cc5c$export$535bd6ca7f90a273() {
  if (typeof (0, import_react19.default)["useSyncExternalStore"] === "function")
    return (0, import_react19.default)["useSyncExternalStore"]($704cf1d3b684cc5c$var$subscribe, $704cf1d3b684cc5c$var$getSnapshot, $704cf1d3b684cc5c$var$getServerSnapshot);
  let cur = (0, import_react19.useContext)($704cf1d3b684cc5c$var$SSRContext);
  return cur.isSSR;
}
...
function Dropdown({
  ...
  const context6 = (0, import_react22.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
var FormCheck = React61.forwardRef(({
  ...
  const innerFormContext = (0, import_react29.useMemo)(() => ({
...
var FormControl = React62.forwardRef(({
  ...
  return (0, import_jsx_runtime58.jsx)(Component2, {
    ...
    readOnly,
    id: id || controlId,
    className: (0, import_classnames45.default)(className, plaintext ? `${bsPrefix}-plaintext` : bsPrefix, size && `${bsPrefix}-${size}`, type === "color" && `${bsPrefix}-color`, isValid && "is-valid", isInvalid && "is-invalid")
  });
});
...
var FormSelect = React67.forwardRef(({
  ...
  return (0, import_jsx_runtime63.jsx)("select", {
    ...
    size: htmlSize,
    ref,
    className: (0, import_classnames49.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, isValid && `is-valid`, isInvalid && `is-invalid`),
    id: id || controlId
  });
});
...
var Switch = React69.forwardRef((props, ref) => (0, import_jsx_runtime65.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var InputGroup = React73.forwardRef(({
  ...
  return (0, import_jsx_runtime70.jsx)(InputGroupContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime70.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames54.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, hasValidation && "has-validation")
    })
  });
});
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react42.useMemo)(function() {
...
var Offcanvas = React89.forwardRef(({
  ...
  const renderBackdrop = (0, import_react43.useCallback)((backdropProps) => (0, import_jsx_runtime85.jsx)("div", {
    ...backdropProps,
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime102.jsxs)(import_jsx_runtime101.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react50.cloneElement)(children, triggerProps), (0, import_jsx_runtime100.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var Pagination = React103.forwardRef(({
  ...
  return (0, import_jsx_runtime105.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames76.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames77.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var ToastFade = React119.forwardRef((props, ref) => (0, import_jsx_runtime123.jsx)(Fade_default, {
  ...props,
  ref,
