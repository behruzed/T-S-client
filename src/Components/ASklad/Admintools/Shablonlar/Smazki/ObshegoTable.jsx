...
export default ({ data, th, spTeacherFunc, spTeacher }) => {
  ...
  const editTeacher = async () => {
    ...
    let res = await axios.put(`${config.url}/obshego/${teacherId}`, data, {
      headers: {
        authorization: window.localStorage.getItem("token"),
      },
    });
  ...
  const delTeacher = async (id) => {
    let res = await axios.delete(`${config.url}/obshego/${id}`, {
      headers: {
        authorization: window.localStorage.getItem("token"),
      },
    });
  ...
  const addTeacher = async () => {
    if (
      ...
      let res = await axios.post(`${config.url}/obshego`, data, {
        headers: {
          authorization: window.localStorage.getItem("token"),
        },
      });
