...
export default ({ th, spTeacherFunc, spTeacher }) => {
  ...
  const editTeacher = async () => {
    ...
    let res = await axios.put(`${config.url}/pos/${teacherId}`, data, {
      headers: {
        authorization: window.localStorage.getItem("token"),
      },
    });
  ...
  const delTeacher = async (id) => {
    let res = await axios.delete(`${config.url}/pos/${id}`, {
      headers: {
        authorization: window.localStorage.getItem("token"),
      },
    });
  ...
  const addTeacher = async () => {
    ...
    if (
      ...
      let res = await axios.post(`${config.url}/pos`, data, {
        headers: {
          authorization: window.localStorage.getItem("token"),
        },
      });
  ...
  const changeStatus = async (e, id) => {
    ...
    console.log(id);
    let res = await axios.put(`${config.url}/addstatuszakritie/${id}`,
      { a: "opened" },
      {
        headers: {
          authorization: window.localStorage.getItem("token"),
              ...
              >
                ...
                <td className="px-6 py-2 pluss2 text-right w-52">
                  ...
                  >
                    ...
                    <button className="addposition2" onClick={(e) => { changeStatus(e, item._id) }}>Добавить</button>
                  </a>
