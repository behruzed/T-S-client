  ...
  return (
    <>
      <div className="text-center rasm">
        <a href="/adminpanel"><img src={logo}></img></a>
      </div>
      <div className="chapbuttons d-block">
        <a href='/adminpanel'><button className="chapbutton">Главная</button></a>
        ...
        <a href='/shablonlar'><button className="chapbutton">Шаблоны</button></a>
        <a href='/ombor'><button className="chapbutton">Склад</button></a>
        <a href='/xodimlar'><button className="chapbutton">Сотрудники</button></a>
        <a href='/info'><button className="chapbutton">Личный кабинет</button></a>
        <br></br>
