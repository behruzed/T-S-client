...
export default ({ data, th, spTeacherFunc, spTeacher }) => {
  ...
  const editTeacher = async () => {
    ...
    let res = await axios.put(`${config.url}/newitem/${teacherId}`, data, {
      headers: {
        authorization: window.localStorage.getItem("token"),
      },
    });
  ...
  const delTeacher = async (id) => {
    let res = await axios.delete(`${config.url}/newitem/${id}`, {
      headers: {
        authorization: window.localStorage.getItem("token"),
      },
    });
  ...
  const addTeacher = async () => {
    if (
      ...
      let res = await axios.post(`${config.url}/newitem`, data, {
        headers: {
          authorization: window.localStorage.getItem("token"),
        },
      });
