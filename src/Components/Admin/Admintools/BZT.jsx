...
export default ({ data, th, spTeacherFunc, spTeacher }) => {
  ...
  const eee = async (e, id) => {
    ...
    let data1 = await axios.get(`${config.url}/bzakritie/?parent=${window.localStorage.getItem("nom")}&forchildren=${window.localStorage.getItem("forchildren")}&thattime=${window.localStorage.getItem("thattime")}`,
      {
        headers: {
  ...
  const getName1 = async (e, id) => {
    ...
    let data2 = await axios.get(`${config.url}/bzakritie/getChild/?parent=${window.localStorage.getItem("nom")}&forchildren=${window.localStorage.getItem("forchildren")}&thattime=${window.localStorage.getItem("thattime")}`,
    {
      headers: {
        authorization: window.localStorage.getItem("token")
      }
  ...
  const editTeacher = async () => {
    ...
    let res = await axios.put(`${config.url}/BZ/${teacherId}`, data, {
      headers: {
        authorization: window.localStorage.getItem("token"),
      },
    });
  ...
  const delTeacher = async (id) => {
    let res = await axios.delete(`${config.url}/BZ/${id}`, {
      headers: {
        authorization: window.localStorage.getItem("token"),
      },
    });
  ...
  const addTeacher = async () => {
    if (
      ...
      let res = await axios.post(`${config.url}/BZ`, data, {
        headers: {
          authorization: window.localStorage.getItem("token"),
        },
      });
