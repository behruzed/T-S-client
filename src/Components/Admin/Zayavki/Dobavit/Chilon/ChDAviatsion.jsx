...
import Table from "./ChDAviatsionTable";
import '../../../style.css'
        ...
        <Breadcrumb className="bread">
          ...
          <div>
                ...
                <div className="container w-full mx-auto py-12">
                        ...
                        <Table data={Aviatsion} th={["Название", "№ Н/Д", "ИД НОМЕР"]} spTeacherFunc={checkHuman} spTeacher={spTeacher} />
                        </div>
                    </div>
                </div>
            </div>
