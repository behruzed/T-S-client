...
import Table from "./ChDKompressorTable";
import '../../../style.css'
        ...
        <Breadcrumb.Item><Link to={"/adminpanel"}>Главная</Link></Breadcrumb.Item>
          ...
          <div>
                ...
                <div className="container w-full mx-auto py-12">
                        ...
                        <Table data={Kompressor} th={["Название", "№ Н/Д", "ИД НОМЕР"]} spTeacherFunc={checkHuman} spTeacher={spTeacher} />
                        </div>
                    </div>
                </div>
            </div>
